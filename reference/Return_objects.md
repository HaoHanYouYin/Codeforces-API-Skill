...
| blogEntry   | [BlogEntry](/apiHelp/objects#BlogEntry) object in short form. Can be absent. |
| comment     | [Comment](/apiHelp/objects#Comment) object. Can be absent.                   |
...
| members          | List of[Member](/apiHelp/objects#Member) objects. Members of the party.                                                                                                                                             |
...
| problem             | [Problem](/apiHelp/objects#Problem) object.                                                                                                                                                                                                                                                          |
| author              | [Party](/apiHelp/objects#Party) object.                                                                                                                                                                                                                                                              |
| programmingLanguage | String.                                                                                                                                                                                                                                                                                             |
| verdict             | Enum: FAILED, OK, PARTIAL, COMPILATION\_ERROR, RUNTIME\_ERROR, WRONG\_ANSWER, WRONG\_ANSWER, TIME\_LIMIT\_EXCEEDED, MEMORY\_LIMIT\_EXCEEDED, IDLENESS\_LIMIT\_EXCEEDED, SECURITY\_VIOLATED, CRASHED, INPUT\_PREPARATION\_CRASHED, CHALLENGED, SKIPPED, TESTING, REJECTED, SUBMITTED. Can be absent. |
...
| hacker              | [Party](/apiHelp/objects#Party) object.                                                                                                                                                                                                                                                                           |
| defender            | [Party](/apiHelp/objects#Party) object.                                                                                                                                                                                                                                                                           |
| verdict             | Enum: HACK\_SUCCESSFUL, HACK\_UNSUCCESSFUL, INVALID\_INPUT, GENERATOR\_INCOMPILABLE, GENERATOR\_CRASHED, IGNORED, TESTING, OTHER. Can be absent.                                                                                                                                                                 |
| problem             | [Problem](/apiHelp/objects#Problem) object. Hacked problem.                                                                                                                                                                                                                                                       |
...
| Field                     | Description                                                                                                                                                                     |
| ------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| party                     | [Party](/apiHelp/objects#Party) object. Party that took a corresponding place in the contest.                                                                                    |
...
| problemResults            | List of[ProblemResult](/apiHelp/objects#ProblemResult) objects. Party results for each problem. Order of the problems is the same as in "problems" field of the returned object. |
